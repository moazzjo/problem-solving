...
This is his method: if the number of distinct characters in one's user name is odd,
 then he is a male, otherwise she is a female. You are given the string that denotes the user name, please help our hero to determine the gender of this user by his method.
...
name_of_the_user = input().casefold()

my_dic = {}
for letter in name_of_the_user:
    my_dic[letter] = None

num_of_distinct = len(my_dic)

if num_of_distinct % 2 == 0:
    print("CHAT WITH HER!")
else:
    print("IGNORE HIM!")
